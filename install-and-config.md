...
update certificate name and path: /etc/pki/nginx/private/ per key e /etc/pki/nginx per crt
...
#
    server {
        ...
        ssl_certificate "/etc/pki/nginx/rh8.marco.net.server.crt";
        ssl_certificate_key "/etc/pki/nginx/private/rh8.marco.net.server.key";
